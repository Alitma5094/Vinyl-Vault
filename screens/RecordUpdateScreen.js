...
function RecordUpdateScreen({ route, navigation }) {
  ...
  const recordItem = recordCtx.records.find(
    (record) => record.id === route.params.id
  );
  ...
  function inputChangeHandler(inputType, enteredValue) {
  ...
  function submitHandler() {
    ...
    albumIsValid = inputValues.album.value.length > 0;
    artistIsValid = inputValues.artist.value.length > 0;
    ...
    recordCtx.updateRecord(recordItem.id, { ...recordData });
    navigation.goBack();
  }
  ...
  function addTrack(title, length) {
    setInputValues((currentInputs) => {
    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          onChangeText={inputChangeHandler.bind(this, "album")}
          mode="outlined"
        />
      </View>
      <View style={styles.inputContainer}>
      ...
      <View style={styles.inputContainer}>
        ...
        <SegmentedButtons
          ...
          onValueChange={inputChangeHandler.bind(this, "rpm")}
          buttons={[
            {
              value: "33 1/3",
              label: "33 1/3",
